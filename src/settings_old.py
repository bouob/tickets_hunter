...
def AdvancedTab(root, config_dict, language_code, UI_PADDING_X):
    ...
    if len(play_sound_filename)==0:
        play_sound_filename = "assets/sounds/ding-dong.wav"
    ...
    icon_play_filename = "assets/icons/icon_play_1.gif"
    icon_play_img = PhotoImage(file=get_resource_path(icon_play_filename))
...
def ServerTab(root, config_dict, language_code, UI_PADDING_X):
    ...
    icon_copy_filename = "assets/icons/icon_copy_2.gif"
    icon_copy_img = PhotoImage(file=get_resource_path(icon_copy_filename))
    ...
    icon_query_filename = "assets/icons/icon_query_5.gif"
    icon_query_img = PhotoImage(file=get_resource_path(icon_query_filename))
...
def AboutTab(root, language_code):
    ...
    logo_filename = "assets/icons/maxbot_logo2_single.ppm"
    logo_img = PhotoImage(file=get_resource_path(logo_filename))
