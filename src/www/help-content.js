    ...
    detail: `
      ...
      <table class="table table-sm table-bordered">
        ...
        <tbody>
          ...
          <tr><td>TicketPlus（遠大）</td><td>優惠序號（exclusive_code）。信用卡卡友驗證讀的是「信用卡前六碼」欄位，不要把卡號填在這裡</td></tr>
    ...
    detailHtml: `
      ...
      <table class="table table-sm table-bordered">
        ...
        <tbody>
          ...
          <tr><td>TicketPlus</td><td>Exclusive discount code. Cardholder verification reads the "First 6 digits of card" field instead, so do not enter card digits here</td></tr>
